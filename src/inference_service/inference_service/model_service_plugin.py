...
class ModelServiceError(RuntimeError):
    """Typed service failure with optional domain response fields."""

    def __init__(self, message: str, **response_fields: object) -> None:
        super().__init__(message)
        self.response_fields = MappingProxyType(dict(response_fields))
...
__all__ = ["ModelServiceError", "ModelServicePlugin", "PluginRuntimeStatus"]
