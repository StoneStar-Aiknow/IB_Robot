...
This package is intentionally additive.  It does not import or modify the
legacy backend/model-session contracts; later factory and facade work can
adapt those components into ``RuntimeAssembly`` explicitly.
"""
