...
def build_chat_messages(
    ...
    system_text = (
        ...
        "Object picking is available only when pick_object appears in the allowed skill list. "
        "Use its target_name argument as the visual text query. Placing and free-form target motion remain disabled.\n"
