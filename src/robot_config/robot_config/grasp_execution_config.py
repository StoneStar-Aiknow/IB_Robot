...
_SCHEMA: dict[str, Any] = {
    ...
    "planner_node": {
        "device": _string(),
        "inference_backend": _enum("local_cuda", "ascend_local"),
    ...
    "verifier_node": {
        "gripper_joint": _string(),
        "joint_state_topic": _string(),
        "joint_current_topic": _string(allow_empty=True),
        ...
        "score_gripper_contact_success": _NON_NEGATIVE,
        "score_gripper_contact_failure": _NON_NEGATIVE,
        "score_gripper_residual_success": _NON_NEGATIVE,
        "score_gripper_residual_failure": _NON_NEGATIVE,
        "score_current_contact_success": _NON_NEGATIVE,
        "score_current_contact_failure": _NON_NEGATIVE,
        "score_wrist_occlusion_success": _NON_NEGATIVE,
        "score_success_threshold": _NON_NEGATIVE,
        "score_failure_threshold": _NON_NEGATIVE,
        "score_margin_threshold": _NON_NEGATIVE,
    },
