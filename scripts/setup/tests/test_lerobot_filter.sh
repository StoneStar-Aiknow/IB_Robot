...
run_fixture "ubuntu-22.04 / py3.10 / desktop profile" \
    "0001-python-compat-syntax-and-metadata.patch,0002-python-compat-min-version-3.10.patch,0003-python-compat-typing-unpack.patch,0005-compat-add-npu-device-detection.patch,0009-adaptive-weight-prerequisites.patch,0011-knowledge-distillation.patch,0014-training-logs.patch,0015-fix-pi05-pad-state-to-max_state_dim-before-prompt-di.patch" \
...
run_fixture "openeuler-embedded-24.03 / py3.11" \
    "0001-python-compat-syntax-and-metadata.patch,0005-compat-add-npu-device-detection.patch,0009-adaptive-weight-prerequisites.patch,0011-knowledge-distillation.patch,0015-fix-pi05-pad-state-to-max_state_dim-before-prompt-di.patch" \
...
run_fixture "openharmony-5.1.0 / py3.12" \
    "0004-openharmony-lazy-import-policy-stack.patch,0009-adaptive-weight-prerequisites.patch,0011-knowledge-distillation.patch,0015-fix-pi05-pad-state-to-max_state_dim-before-prompt-di.patch" \
