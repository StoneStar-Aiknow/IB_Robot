...
| `pkg_build_type` | 构建系统 | `"autotools"` / `"cmake"` / `"meson"` |
...
| 包 | 版本 | 依赖 | PR |
|----|------|------|-----|
| libncursesw | 6.5 | - | 仓库已有 |
| bash | 5.2 | libncursesw | [#2](https://atomgit.com/openharmony-robot/tools_ohloha_pkgs/pull/2) |
| vim | 9.1.1989 | libncursesw, libreadline, libgettext, python3 | 仓库已有（VIMRUNTIMEDIR 修复见 [#3](https://atomgit.com/openharmony-robot/tools_ohloha_pkgs/pull/3)） |
| zsh | 5.9 | libncursesw | [#4](https://atomgit.com/openharmony-robot/tools_ohloha_pkgs/pull/4) |
